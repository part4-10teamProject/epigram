    ...
    <form onSubmit={handleSubmit}>
      <div className="flex min-h-screen items-center justify-center">
        <div className="">
          ...
          <div className="flex h-[42px] w-full flex-row-reverse flex-wrap gap-2 pt-8 md:h-[48px] md:w-[384px] xl:h-[56px] xl:w-[614px]">
            {tags.map((tags) => (
              <div
                className="flex items-center justify-center rounded-3xl bg-[#F5F7FA] xl:gap-2 xl:px-[14px] xl:py-3"
                key={tags}
              >
                <p className="grid place-items-center text-[#5E5E5E] xl:text-[24px] xl:font-normal xl:leading-8">
                  {tags}
                </p>
              </div>
            ))}
