...
const FeedCard: React.FC<FeedProps> = ({ epigramData }) => {
  return (
    <div className="flex flex-col gap-2">
      <div className="h-[140px] w-[312px] cursor-pointer rounded-[16px] border border-[#F2F2F2] bg-striped p-[24px] drop-shadow md:h-[180px] md:w-[294px] xl:h-[259px] xl:w-[585px]">
